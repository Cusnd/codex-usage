import { SYNC_HEADER, SYNC_VERSION, VERSION_MISMATCH, type CloudCompatibility } from '../../modules/contracts/cloud-version.js';
import { deviceAuth } from './devices.js';
import { sessionUser } from './auth.js';
import { json } from '../../modules/platform/worker/http.js';
