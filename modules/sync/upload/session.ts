import { SYNC_HEADER, SYNC_VERSION, CloudVersionError, checkCloudVersion } from "../../contracts/cloud-version.js";
import { createHash, randomBytes } from "node:crypto";
import { existsSync, readFileSync } from "node:fs";
import { hostname } from "node:os";
import { CLOUD_ORIGIN, type CloudStatus } from "../../contracts/cloud.js";
import type { LimitObservation } from "../../accounts/refresh.js";
import type { Store } from "../../storage/sqlite.js";
import { AccountSync } from "../../accounts/publisher.js";
import type { V3Uploader } from "./uploader.js";
import type { AccountUsage } from "../../contracts/accounts.js";
import { type Credentials, writeCredentials } from './credentials.js';
...
export class CloudSync {
  ...
  private saveCredentials(c: Credentials | null) {
    writeCredentials(this.options.credentialFile,c);
    this.credentials=c;
  }
  start() {
    this.schedule();
