...
import { CloudDeviceSettings } from '../devices/DeviceSettings.js';
...
import { CloudProjects } from '../projects/CloudProjects.js';
import { CloudOrigins } from '../projects/CloudOrigins.js';
import { Header, SourceBadge, time } from "../../widgets/ui.js";
import { Workspace } from "../../data/workspace.js";
import { AdaptiveRegion } from "../../motion/MotionPrimitives.js";
...
export function SettingsPage() {
  ...
  return (
    <>
      <Header
        title="设置"
        description={deviceScope ? '管理采集设备，调整云端显示并查看同步状态。' : '控制更新频率，查看当前数据的覆盖与状态。'}
      />
      {!deviceScope && <SystemSettings />}
      {deviceScope ? <CloudDeviceSettings /> : <CloudSettings />}
      {deviceScope && <CloudProjects />}
      {deviceScope && <CloudOrigins />}
      ...
      {!deviceScope && <section className="panel">
        <h2>数据源状态</h2>
