...
import type { Filter, GroupRow, Metrics, ThreadRow } from '../../../contracts/query.js';
import type { Page } from '../../../contracts/responses.js';
import { compact, percent } from '../../ui/format.js';
import { SessionPanel } from "./AtlasSession.js";
import {
  Group,
  SearchField,
  SortChoice,
...
import { ErrorBox, Loading, Pagination, time } from "../../widgets/ui.js";
import {
  CostValue,
  UsageBreakdown,
  UsageCells,
...
import { ResultRegion, useHierarchyMotion } from "../../motion/MotionPrimitives.js";
                ...
                >
                  ...
                  <td>
                    <button
                      ...
                      aria-label={`查看 ${sessionTitle(row, projectName)} 的轮次`}
                      onClick={() => onSelect(row.id)}
                    >
