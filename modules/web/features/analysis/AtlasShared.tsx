...
import type { Filter, Metrics, TurnRow } from '../../../contracts/query.js';

import { Choice } from "../../ui/Choice.js";
import { FilterBar, time } from "../../widgets/ui.js";
import { useData, useRange, Workspace } from "../../data/workspace.js";
import { markQueryMotion } from "../../motion/motion-state.js";
import { MotionDetails, PresenceList } from "../../motion/MotionPrimitives.js";
...
export function ActiveScope() {
  ...
  return (
    <div className="atlas-scope-chips">
      <span>
        {summary.data?.meta.exampleData ? "示例数据" : deviceScope ? "所选设备记录" : "本机记录"}
      </span>
