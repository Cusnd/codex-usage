...
import { readTrendParent, selectedBrushIndices } from "./trend-range.js";
import { ErrorBox, Loading, time } from "../../widgets/ui.js";
    ...
    <section className="atlas-time">
      ...
      <div ref={layout.ref} className={"atlas-trend-grid " + (collapsed ? "is-collapsed" : "")}>
        ...
        <div className="atlas-total">
          ...
          <small>{r.timezone} · {deviceScope ? "所选设备记录" : "本机记录"}</small>
        </div>
      </div>
