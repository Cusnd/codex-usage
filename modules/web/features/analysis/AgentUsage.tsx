...
import type { AgentUsage, Filter } from '../../../contracts/query.js';
import { Workspace, useData } from "../../data/workspace.js";
import { compact, exact } from '../../ui/format.js';
import { CostValue, costLabel, sessionTitle } from "../../widgets/Usage.js";
import { MotionDetails } from "../../motion/MotionPrimitives.js";
import { ErrorBox, Loading } from "../../widgets/ui.js";
                ...
                <td>
                  <div className="agent-name" style={{ paddingInlineStart: Math.min(agent.depth, 5) * 14 }}>
                    ...
                    <Link to={`/threads/${encodeURIComponent(agent.id)}?${navigationSearch(location.search,{},true)}`} state={{ from: location.pathname + location.search }} title={agent.id}>
                      {sessionTitle(agent, projectName)}
                    </Link>
