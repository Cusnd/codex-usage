...
import { completeLines } from "./framing.js";
import { projectLine, sha256, nextChain, EMPTY_CHAIN } from "./projection.js";
import { initialContext, nextContext } from "../usage/normalize.js";
import { EXTRACTOR_VERSION, stableJson, V3_MAX_DECODED_BYTES, V3_TARGET_BYTES, type UploadBatch, type Lane, type SyncMetadata } from "../contracts/sync.js";
import type { Observation } from "../usage/types.js";
import { type CollectionMetrics, type CollectorOptions, type Source, type SourceState } from "./types.js";
import { discoverSources } from "./discovery.js";
import { flushLocalBatches } from './outbox.js';
...
export class Collector {
  ...
  private async discover(m:CollectionMetrics) {
    const files=await discoverSources(this.sourceRoot);
  ...
  flushLocal() { flushLocalBatches(this.store,this.options.onBatch); }
...
export type { CollectionMetrics } from './types.js';
