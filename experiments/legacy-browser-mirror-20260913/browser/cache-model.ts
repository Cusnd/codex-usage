import { stableJson, type SyncCut, type SyncEntity, type EntityKind } from '../../../modules/contracts/sync.js';
...
/** Online results may use a verified cold-start lease before the entity cache is complete. */
export const queryLeaseOf = (state: CacheState | null | undefined): ReadLease | null => state?.activeLease ?? state?.baseline?.lease ?? null;
