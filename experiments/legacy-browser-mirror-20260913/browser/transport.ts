import { type ChangesPage, type SnapshotManifestPage, type SyncCut, type SyncEntity } from '../../../modules/contracts/sync.js';
import { SYNC_HEADER, SYNC_VERSION, assertCloudVersion, VERSION_MISMATCH } from "../../../modules/contracts/cloud-version.js";
...
export class HttpSyncTransport implements SyncTransport {
  ...
  manifest(lease: string, cursor: string | null, signal?: AbortSignal) {
    const params = new URLSearchParams({ limit: '500' }); if (cursor !== null) params.set('cursor', cursor);
