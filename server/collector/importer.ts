...
import {Collector,type CollectionMetrics} from './store.js';
import {LocalMaterializer} from '../local-materializer.js';
import {ProjectSourceResolver,type ResolvedProjectSource} from '../project-source.js';
import type {SyncMetadata} from '../../shared/sync-v3.js';
import {sha256} from './projection.js';
import {stableJson} from '../../shared/sync-v3.js';
