...
const candidates = [process.env.CODEX_USAGE_CLI, config?.cli, fileURLToPath(new URL('../../../bin/codex-usage.mjs', import.meta.url)), path.join(process.env.LOCALAPPDATA || '', 'CodexUsage/tools/node_modules/codex-detailed-usage/bin/codex-usage.mjs')];
