/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3508de4422599d2bba566b8f94a80bb5)
// Runtime types generated with workerd@1.20260908.1 2026-09-10 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	AUTH_LIMITER: RateLimit;
	ASSETS: Fetcher;
	APP_ORIGIN: "https://quota.esoren.com";
	GITHUB_CLIENT_ID: "Ov23lib5pCf2LFFUVUar";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../apps/cloud/index.js");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "GITHUB_CLIENT_ID">> {}
}
