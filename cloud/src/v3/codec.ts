import { V3_CONTENT_TYPE, V3_MAX_DECODED_BYTES, V3_MAX_WIRE_BYTES, stableJson, validUploadBatch, type UploadBatch } from '../../../shared/sync-v3';
import { fail, HttpError, sha256 } from '../http';
